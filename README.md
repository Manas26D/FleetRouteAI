...
Multi-vehicle delivery route optimization (VRP)
Warehouse/depot-based fleet routing
Interactive route visualization using Folium
Static route plotting using Matplotlib
Cached graph generation using gzip + pickle for faster reloads
CLI-based logistics simulation
